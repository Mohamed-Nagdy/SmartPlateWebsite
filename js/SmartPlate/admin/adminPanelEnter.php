							...
							while($row = mysqli_fetch_array($data)){
								...
								echo "
									...
									<div>
										...
										<td> <div class='zamo'><a href='adminPanelEnter.php?action=delete&adminId=$adminId&type=admins'><img src='../img/delete1.png' height='50' width='50'></a> </div></th>
										</td>
							...
							while($row = mysqli_fetch_array($data)){
								...
								echo "
									<div>
										...
										<td> <div class='zamo'><a href='adminPanelEnter.php?action=delete&doctorId=$doctorId&type=doctors'><img src='../img/delete1.png' height='50' width='50'></a> </div></th>
										</td>
...
//								<a href='adminPanelEnter.php?action=edit&userId=$userId&type=users'><img src='edit.png' height='50' width='50'></a>
								echo "
									...
									<div>
										...
										<td> <div class='zamo'><a href='adminPanelEnter.php?action=delete&userId=$userId&type=users'><img src='../img/delete1.png' height='50' width='50'></a> </div></td>
...
//								<a href='adminPanelEnter.php?action=edit&postId=$postId&type=posts'><img src='edit.png' height='50' width='50'></a>
								echo "
									<table>
										...
										<td> <div class='zamo'><a href='adminPanelEnter.php?action=delete&postId=$postId&type=posts'><img src='../img/delete1.png' height='50' width='50'></a> </div></td>
