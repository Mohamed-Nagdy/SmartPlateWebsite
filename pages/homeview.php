					...
					<div class="collapse navbar-collapse " id="navbarSupportedContent-333">	
							...
							<?php
								...
								if(isset($_SESSION["mode"])){
									...
									echo "
												<li  class='nav-item active txtclr'> <a  id='ap' class='nav-link' href='allPosts.php'>ALL POSTS</a> </li>
											</ul>
										<ul class='navbar-nav ml-auto nav-flex-icons mr-auto' >
											<li class='nav-item dropdown'>
												...
												<div class='dropdown-menu dropdown-menu-right dropdown-default '	aria-labelledby='navbarDropdownMenuLink-333'>
													<a class='txtclr dropdown-item' href='userPage.php'>PROFILE</a>
								...
								// else we fetch the anonymous mode
									...
									echo "
													<li  class='nav-item align-self-center '> <a  class='txtclr nav-link' href='login.php'> LOGIN</a> </li>
													<li  class='nav-item align-self-center '> <a  class='txtclr nav-link' href='signUp.php'>SIGN UP</a> </li>
												</ul>
											</div>
									";
								}
									...
									if($_SESSION["userType"] == "U"){
										...
										echo "
												...
												<div class='card-body text-primary'>
													<h5 class='card-title '><a class='txtclr' href='userPage.php'>$userName</a></h5>
										...
										echo "
												...
												<div class='card-body text-primary'>
													<h5 class='card-title '><a class='txtclr' href='doctorPage.php'>$userName</a></h5>
												</div>
											</div>
